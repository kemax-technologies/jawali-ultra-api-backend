...
try {
    ...
    json_ok([
        ...
        'endpoints'  => [
            ...
            // 🏢 لوحة تحكم المدير الويب (Admin Web Panel — يتطلب دور مدير)
            'admin_dashboard.php?type=overview',
            'admin_dashboard.php?type=realtime',
            'admin_dashboard.php?type=branches',
            'admin_dashboard.php?type=sales_chart&period=month',
            'admin_dashboard.php?type=top_cashiers&period=week',
            'admin_dashboard.php?type=alerts',
            'admin_dashboard.php?type=compare&period=month',
            'branches.php',
            'admin_users.php',
            'admin_users.php?action=reset',
            'admin_users.php?action=toggle',
            'admin_users.php?action=move',
